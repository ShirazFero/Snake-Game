...
public class SidePanel extends JPanel {
	...
	private static final int LARGE_OFFSET = 50;//50
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("player: " + game.getPlayerName(), LARGE_OFFSET, drawY += MESSAGE_STRIDE);
		...
		g.drawString("lifes: " + game.getLifes(), LARGE_OFFSET, drawY += MESSAGE_STRIDE);
