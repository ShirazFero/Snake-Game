...
public class BoardPanel extends JPanel {
	...
	private BufferedImage QImageM;
	private BufferedImage QImageH;
	...
	public void paintComponent(Graphics g) {
		...
		if(game.isGameOver() || game.isNewGame() || game.isPaused()) {
			...
			if(game.isNewGame()) {
				...
				smallMessage2="Press esc to back home";
			...
			if(smallMessage2!=null)
			g.drawString(smallMessage2, centerX - g.getFontMetrics().stringWidth(smallMessage2) / 2, centerY + 80);
		}
	}
	...
	private void drawTile(int x, int y, TileType type, Graphics g) {
		...
		case Banana:
			...
			g.fillOval(x+6, y+6, TILE_SIZE - 4, TILE_SIZE - 4);
			break;
		case Pear:
...
//			try {
//				QImage=ImageIO.read(getClass().getResourceAsStream("/whiteQ.jpg"));
//			} catch (IOException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
//			 g.drawImage(QImage, x +6, y +6, 15, 15,null);
			g.setColor(Color.white);
			g.fillOval(x+6, y+6, TILE_SIZE - 4, TILE_SIZE - 4);
			break;
		case Medium_Ques:
...
//			try {
//				QImageM=ImageIO.read(getClass().getResourceAsStream("/yellowQ.png"));
//			} catch (IOException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
//			 g.drawImage(QImageM, x +6, y +6, 15, 15,null);
...
//			try {
//				QImageH=ImageIO.read(getClass().getResourceAsStream("/HardQ.png"));
//			} catch (IOException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
//			 g.drawImage(QImageH, x +6, y +6, 15, 15,null);
			g.setColor(Color.RED);
			g.fillOval(x+6, y+6, TILE_SIZE - 4, TILE_SIZE - 4);
			break;
